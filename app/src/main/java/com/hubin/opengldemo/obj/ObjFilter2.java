...
import com.hubin.opengldemo.filter.AFilter;
 ...
 * @文件名: ObjFilter2
 * @创建者: 胡英姿
 * @创建时间: 2018/9/15 17:31
 * @描述： TODO
 */
public class ObjFilter2 extends AFilter {
    private String obj_dir;
    ...
    public ObjFilter2(Resources mRes,String obj_dir) {
        super(mRes);
    ...
    protected void onCreate() {
        ...
        if(obj!=null&&obj.mtl!=null){
            try {
                LogUtils.e("纹理"+obj_dir+obj.mtl.map_Kd+"  "+obj.mtl.newmtl);
                String fileName =obj_dir+obj.mtl.map_Kd;
                textureId=createTexture(BitmapFactory.decodeStream(mRes.getAssets().open(fileName)));
